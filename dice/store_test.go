...
func TestDecodeJSONStrictAllowsStoreFormatVersionMetadata(t *testing.T) {
	...
	packageRaw := `{"id":"alice/demo","formatVersion":"1.0.0","version":"1.2.3","name":"Demo","contents":["scripts"],"download":{"url":"https://example.com/demo.sealpack","zipUrl":"https://example.com/demo.zip"}}`
	var pkg StorePackage
