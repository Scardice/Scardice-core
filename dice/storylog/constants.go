...
const (
	...
	ExportJsonFilename    = "Scardice-standard-log.json"
	ExportParquetFilename = "Scardice-standard-log.parquet"
	ExportReadmeFilename  = "README.txt"
	ExportReadmeContent   = ExportTxtFilename + ": 纯文本 Log\n" + ExportJsonFilename + ": 余烬标准 Log, 粘贴到染色器可格式化。若是Parquet的格式，暂时无法处理。\n"
