...
因为余烬一直缠着{$t玩家}，所以只好先陪他玩啦——|鹊鹊结合实际经历创作
...
观看余烬顶球的时候站的太近被溅了一身水，换衣服的功夫{$t玩家}发现开团时间已经错过了。|鹊鹊结合实际经历创作
不知为什么平坦的路面上会躺着一只余烬，就那样玩着手机没注意就被绊倒昏过去了！可怜的{$t玩家}！|鹊鹊结合实际经历创作
...
.ww set clr // 取消修改`
	...
	cmdCheckHelp := `.check // 生成余烬校验码，可用于在官网校验是否是可信余烬
.check --plain // 生成 ASCII 字符的余烬校验码`
